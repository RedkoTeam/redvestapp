...
import ticker from "../../assets/images/Info/Title.png"
...
function slInfo() {
  ...
  return (
      ...
      <View style={{flexDirection: 'row', width: '100%', justifyContent: 'space-between', padding: 10, marginTop: 5 }}>
                        ...
                        <Image source={ticker} style={{resizeMode:'contain',width:widthPercentageToDP(30), height:heightPercentageToDP(25), marginBottom: '-20%', right:'150%'}} />
                    </View>
