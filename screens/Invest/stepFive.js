...
function stepFive() {
  ...
  return (
      ...
      <View style={{flexDirection: 'row', width: '100%', justifyContent: 'space-between', padding: 10, marginTop: 5 }}>
                        <TouchableOpacity onPress={()=>navigation.navigate('stepFour')} style={{
                                    left:widthPercentageToDP(3),
                                    top:heightPercentageToDP(3),
                                }}>
                                        <Image source={back} style={{width :widthPercentageToDP('3'), height :heightPercentageToDP('3'), resizeMode:'contain'}} />
                        </TouchableOpacity>
                        <Image source={title} style={{resizeMode:'contain',width:widthPercentageToDP(50), height:heightPercentageToDP(15), marginTop: '0%', left:'-70%'}} />
                    </View>
        <ScrollView style={{height:'200%'}}>
              ...
              <View>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('stepFiveA')}>
                  <Image source={next} style={{resizeMode:'contain',width:widthPercentageToDP(85), height:heightPercentageToDP(11),marginTop:'10%'}}/>
                </TouchableOpacity>
                </View>
              </View>
              </ScrollView>
